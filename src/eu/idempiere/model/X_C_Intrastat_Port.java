...
/** Generated Model for C_Intrastat_Port
 *  @author iDempiere (generated) 
 *  @version Release 8.2 - $Id$ */
public class X_C_Intrastat_Port extends PO implements I_C_Intrastat_Port, I_Persistent 
{
    ...
    public X_C_Intrastat_Port (Properties ctx, int C_Intrastat_Port_ID, String trxName)
    {
      super (ctx, C_Intrastat_Port_ID, trxName);
      /** if (C_Intrastat_Port_ID == 0)
        {
			setC_Intrastat_Port_ID (0);
			setName (null);
        } */
    }

    /** Load Constructor */
    public X_C_Intrastat_Port (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_Intrastat_Port[")
	...
	/** Set C_Intrastat_Port_UU.
		@param C_Intrastat_Port_UU C_Intrastat_Port_UU	  */
	public void setC_Intrastat_Port_UU (String C_Intrastat_Port_UU)
	{
		set_ValueNoCheck (COLUMNNAME_C_Intrastat_Port_UU, C_Intrastat_Port_UU);
	}

	/** Get C_Intrastat_Port_UU.
		@return C_Intrastat_Port_UU	  */
	public String getC_Intrastat_Port_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_Intrastat_Port_UU);
	}
	...
	{
		set_Value (COLUMNNAME_porttype, Boolean.valueOf(porttype));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_porttype);
		if (oo != null) 
		{
